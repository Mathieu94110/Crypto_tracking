...
export default function TopSevenTrending() {
    ...
    return (
        <div style={{ width: '500px', height: '500px', border: "2px solid #000", borderRadius: "2%", background: 'linear-gradient(to bottom left, #f83600, #f9d423)', margin: "0 auto", color: "#fff", verticalAlign: "middle" }}>
